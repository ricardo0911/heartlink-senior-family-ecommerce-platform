  ...
  <view class="page">
    <view class="panel">
      <view class="panel-head">
        <text class="panel-title">忘记密码</text>
        <text class="panel-subtitle">输入手机号并设置新密码，完成后返回登录</text>
      </view>
      ...
      <view class="field-card">
        ...
        <input class="field-input" type="password" v-model="password" placeholder="请输入新密码" />
      </view>

      <view class="field-card">
        <text class="field-label">确认新密码</text>
        <input class="field-input" type="password" v-model="confirmPassword" placeholder="请再次输入新密码" />
      </view>

      <button class="primary-btn" :loading="loading" @click="submit">重置密码</button>
